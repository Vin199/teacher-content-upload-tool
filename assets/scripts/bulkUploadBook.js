...
bookWb.SheetNames.push("Relations and Functions");
bookWb.SheetNames.push("Algebra");
bookWb.SheetNames.push("Calculus");
bookWb.SheetNames.push("Probability");

let book_ws_header = [["name", "link"]];
let book_ws_1 = XLSX.utils.aoa_to_sheet(book_ws_header);

let book_ws_2 = XLSX.utils.aoa_to_sheet(book_ws_header);

let book_ws_3 = XLSX.utils.aoa_to_sheet(book_ws_header);

let book_ws_4 = XLSX.utils.aoa_to_sheet(book_ws_header);

bookWb.Sheets["Relations and Functions"] = book_ws_1;
bookWb.Sheets["Algebra"] = book_ws_2;
bookWb.Sheets["Calculus"] = book_ws_3;
bookWb.Sheets["Probability"] = book_ws_4;
